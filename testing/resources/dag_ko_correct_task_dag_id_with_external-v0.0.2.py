...
with models.DAG(
    dag_id="dag_ko_correct_task_dag_id_with_external-v0.0.1",
    ...
    # Simulating external operator
    t_external = DummyOperator(
        task_id='prose_data_external-v0.0.1',
        external_task_id='prose_data2_external_task-v0.0.5',
        external_dag_id='prose_data2_external_dag_id-v0.0.9',
    )
